...
public class TerminalStyleFactory implements GUIFactory {
	...
	public Button createButton(String title) {
		...
		button.setStyle("-fx-border-color: " + WHITE_HEX_CODE + "; -fx-border-width: " + BORDER_WIDTH + "; -fx-background-color: " + BLACK_HEX_CODE + "; -fx-border-radius: "+CORNER_RADIUS+"; -fx-background-radius: "+CORNER_RADIUS+";");
		return button;
	}
